...
import com.github.sikoried.jstk.io.LabelFrameInputStream;
import com.github.sikoried.jstk.io.SampleInputStream;
import com.github.sikoried.jstk.stat.Sample;
import com.github.sikoried.jstk.util.Arithmetics;
import com.github.sikoried.jstk.util.LabelTranslator;
...
public class LDA extends Projection {
	...
	public void estimate(HashMap<Short, Double> priors) {
		...
		for (int i = 0; i < fd; ++i)
			sortedEV.add(Pair.of(vhelp[i], eig.getD().get(i, i)));
