...
package com.github.sikoried.jstk.app.blitzscribe;
...
import com.github.sikoried.jstk.vc.VisualizerSpeechSignal;
...
public class AudioPanel extends JPanel {
	...
	public AudioPanel() {
		...
		progressListener = new ThreadedPlayer.ProgressListener() {
			private int count = 0;
