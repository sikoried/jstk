...
*/
package com.github.sikoried.jstk.stat.hmm;
...
import com.github.sikoried.jstk.stat.MleMixtureAccumulator;
...
public final class SCState extends State {
	private static Logger logger = LogManager.getLogger(SCState.class);
