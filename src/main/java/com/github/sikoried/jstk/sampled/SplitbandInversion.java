...
package com.github.sikoried.jstk.sampled;

import com.github.sikoried.jstk.sampled.filters.Butterworth;
...
public class SplitbandInversion implements AudioSource {
	public static Logger logger = LogManager.getLogger(SplitbandInversion.class);
